                    ...
                    const initialDemoData = [
                        {
                            ...
                            search_data: {
                                aircraft_details: { year: 2012, make: 'GULFSTREAM', model: 'G650', serial: '6021' },
                        ...
                        },
                        {
                            ...
                            search_data: {
                                aircraft_details: { year: 2019, make: 'HONDA', model: 'HA-420', serial: '42000123' },
                        ...
                        },
                        {
                            ...
                            search_data: {
                                aircraft_details: { year: 2021, make: 'CIRRUS', model: 'SF50', serial: '0321' },
                                metrics: { risk_score: 25, alpha: 100, mission_fit: 95 }
                            }
                        }
                    ];
                    localStorage.setItem('demo_searches', JSON.stringify(initialDemoData));
                ...
                <div className="fixed inset-0 z-[200] flex flex-col items-center justify-center bg-black/90 backdrop-blur-2xl animate-fade-in transition-all">
                    <div className="relative flex flex-col items-center">
                        ...
                        <div className="flex items-center gap-3">
                            <span className="text-[10px] font-black text-emerald-500 tracking-[0.4em] uppercase opacity-60">Forensic Pipeline Active</span>
                        </div>
                    </div>
                    ...
                    <div className="absolute bottom-12 flex items-center gap-2 opacity-20">
                        ...
                        <span className="text-xs font-black tracking-widest text-white uppercase">goTailScan / High-Performance Intelligence</span>
                    </div>
                </div>
            )}
                ...
                {result && (
                    ...
                    >
                        ...
                        <div style={{
                            ...
                            alignItems: 'center',
                            gap: '40px',
                            background: riskLevel === 'HIGH' ? 'rgba(239, 68, 68, 0.1)' : riskLevel === 'MEDIUM' ? 'rgba(234, 179, 8, 0.1)' : 'rgba(16, 185, 129, 0.1)',
                            borderLeft: `4px solid ${riskLevel === 'HIGH' ? '#ef4444' : riskLevel === 'MEDIUM' ? '#eab308' : '#10b981'}`
                        }}>
                            <div style={{ flex: '0 0 auto' }}>
                                <CircularGauge score={riskScore} size={180} strokeWidth={16} mode="risk" />
                            </div>

                            <div style={{ flex: 1 }}>
                                <div style={{ marginBottom: '24px' }}>
                                    <div style={{ fontSize: '10px', color: '#9ca3af', fontWeight: 'bold', textTransform: 'uppercase', letterSpacing: '2px', marginBottom: '8px' }}>Forensic Index</div>
                                    <h2 style={{ fontSize: '36px', fontWeight: '900', color: 'white', textTransform: 'uppercase', margin: 0 }}>{riskLevel} RISK PROFILE</h2>
                                    ...
                                    <div style={{ marginTop: '16px', display: 'flex', gap: '12px' }}>
                                        ...
                                        <div style={{ padding: '6px 12px', background: 'rgba(255,255,255,0.05)', borderRadius: '6px', fontSize: '11px', color: '#94a3b8' }}>
                                            <span style={{ color: '#64748b', marginRight: '4px' }}>ID:</span> {result.aircraft_details?.serial || 'N/A'}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <motion.div
                                    ...
                                    style={{ fontSize: '16px', color: '#d1d5db', lineHeight: '1.6', maxWidth: '600px' }}
                                >
                                    {result.ai_intelligence?.technical_advisory || 'Genealogical forensic analysis complete. High-confidence data correlation achieved.'}
                                </motion.div>

                                <div style={{ marginTop: '20px', display: 'flex', gap: '10px' }}>
                                    <div style={{ padding: '4px 12px', borderRadius: '4px', background: riskLevel === 'HIGH' ? 'rgba(239, 68, 68, 0.2)' : riskLevel === 'MEDIUM' ? 'rgba(234, 179, 8, 0.2)' : 'rgba(16, 185, 129, 0.2)', color: riskLevel === 'HIGH' ? '#ef4444' : riskLevel === 'MEDIUM' ? '#eab308' : '#10b981', fontSize: '11px', fontWeight: '900', textTransform: 'uppercase' }}>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '24px' }}>
                            ...
                            <div style={cardStyle}>
                                ...
                                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                                    <div style={{ padding: '16px', background: 'rgba(0,0,0,0.3)', borderRadius: '8px', border: '1px solid rgba(255,255,255,0.1)', display: 'flex', alignItems: 'center', gap: '16px' }}>
                                        <div style={{ flex: '0 0 auto' }}>
                                            <CircularGauge score={salinityData.score} size={60} strokeWidth={6} mode="risk" />
                                        </div>
                                        <div>
                                            <div style={{ fontSize: '10px', color: '#6b7280', textTransform: 'uppercase', marginBottom: '4px' }}>Corrosion Risk</div>
                                            <div style={{ fontSize: '12px', color: '#9ca3af', marginTop: '4px', fontWeight: 'bold' }}>{salinityData.risk} EXPOSURE</div>
                                        </div>
                                    </div>
                            ...
                            {result.predictive_maintenance && (
                                <div style={{
                                    ...cardStyle,
                                    background: 'linear-gradient(135deg, rgba(88, 28, 135, 0.15), rgba(0, 0, 0, 0.4))',
                                    border: '1px solid rgba(139, 92, 246, 0.3)',
                                    boxShadow: '0 0 40px rgba(139, 92, 246, 0.1)'
                                }}>
                                    <div style={{ marginBottom: '24px' }}>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
                                            <div style={{ fontSize: '10px', color: '#a855f7', fontWeight: 'bold', textTransform: 'uppercase', letterSpacing: '2px' }}>Forensic Depth</div>
                                            <div style={{ padding: '4px 12px', borderRadius: '4px', background: 'rgba(168, 85, 247, 0.2)', color: '#a855f7', fontSize: '10px', fontWeight: 'bold' }}>
                                    ...
                                    <div style={{ display: 'grid', gap: '16px' }}>
                                        {result.predictive_maintenance.alerts.map((alert, i) => (
                                            <div key={i} style={{ padding: '20px', background: 'rgba(0,0,0,0.4)', borderRadius: '12px', border: `1px solid ${alert.risk === 'HIGH' ? 'rgba(239, 68, 68, 0.3)' : 'rgba(139, 92, 246, 0.2)'}` }}>
                                                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start', marginBottom: '12px' }}>
                                                    <div>
                                                        <div style={{ fontSize: '14px', fontWeight: 'bold', color: 'white', marginBottom: '4px' }}>{alert.component}</div>
                                                        <div style={{ fontSize: '11px', color: '#9ca3af' }}>{alert.source}</div>
                                                    </div>
                                                    <div style={{ textAlign: 'right' }}>
                                                        <div style={{ fontSize: '18px', fontWeight: '900', color: alert.risk === 'HIGH' ? '#ef4444' : '#a855f7' }}>{alert.probability}%</div>
                                                        <div style={{ fontSize: '9px', color: '#6b7280', textTransform: 'uppercase' }}>Probability</div>
                                                    </div>
                                                </div>
                                                ...
                                                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: '10px' }}>
                                                    <span style={{ color: '#a855f7', fontWeight: 'bold' }}>Window: {alert.timeframe}</span>
                                                    <span style={{ color: alert.risk === 'HIGH' ? '#ef4444' : '#fbbf24', fontWeight: 'bold' }}>Risk: {alert.risk}</span>
                                                </div>
                                            </div>
                                        ))}
                                    </div>

                                    <div style={{ marginTop: '24px', padding: '16px', borderRadius: '8px', background: 'rgba(168, 85, 247, 0.1)', border: '1px solid rgba(168, 85, 247, 0.2)' }}>
                                        ...
                                        <div style={{ fontSize: '11px', color: '#a855f7', lineHeight: '1.5' }}>
                                            <strong>Negotiation Leverage:</strong> These predicted failures are not reflected in current logbooks but are high-probability events.
                                            System recommends requesting specific eddy-current inspections for these components or negotiating a price reduction of <strong>-5% to -8%</strong> to cover imminent recommissioning costs.
                                        </div>
                                    </div>
                                </div>
                            )}
