...
console.log('🔍 Testing N350KA Valuation...\n');

const supabase = createClient(supabaseUrl, supabaseServiceKey);

async function testN350KA() {
    // Check database
    ...
    if (dbData) {
        ...
        console.log('   type_engine:', dbData.type_engine); // 5=Turbo-shaft, etc.
        console.log('   type_aircraft:', dbData.type_aircraft);
    }
    console.log('');
    ...
    if (orchData) {
        ...
        console.log('   Valuation:', orchData.valuation);
    }
    console.log('');
}
